...
require('lazy').setup {
  ...
  --require 'plugins.dashboard.startify',
  ...
  require 'plugins.editing.coqNvim',
  ...
  require 'plugins.searchReplace.multiFileSearchReplace',
  require 'plugins.searchReplace.ripgrepUseAndLearn',
  require 'plugins.searchReplace.quickfix',
  require 'plugins.terminal.terminal',
  require 'plugins.terminal.hkInTerminal',
  require 'plugins.codeRunner.codeRunner',
}
