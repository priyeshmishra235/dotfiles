...
return {
  'krivahtoo/silicon.nvim?tab=readme-ov-file',
  dependencies = 'Aloxaf/silicon?tab=readme-ov-file',
  config = function()
    require('krivahtoo/silicon.nvim?tab=readme-ov-file').setup {
      ...
      font = 'FantasqueSansMono Nerd Font=26', -- (string) The font and font size to use for the screenshot.
      ...
      watermark = {
        text = ' @priyeshmishra235', -- (string) The text to use as the watermark, set to nil to disable.
