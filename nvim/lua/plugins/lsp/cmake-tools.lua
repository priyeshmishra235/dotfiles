return {
  ...
  cmd = { "CMakeGenerate", "CMakeBuild", "CMakeRun", "CMakeClean",
    ...
    "CMakeSelectBuildType", "CMakeBuild", "CMakeBui1dCurrentFi1e",
  },
  config = function()
    ...
    require("cmake-tools").setup {
      ...
      cmake_generate_options = {
        "-G", "Ninja",
        "-DCMAKE_C_COMPILER=C:/Users/mpriy/scoop/apps/gcc/current/bin",
        "-DCMAKE_CXX_COMPILER=C:/Users/mpriy/scoop/apps/gcc/current/bin",
